...
d1=read.csv('C:/Users/xiaohao/Documents/Rwork/TestData_24_08_10.CSV', header=TRUE)
...
name_of_excel<-list("2408_test_gamma_output_10.xlsx")
name_of_plot<-list("2408_test_gamma_output_10")
...
for (i in 1:1){
  ...
  for(k in 2:2){
    ...
    options(digits=3)
    prevalence<-prevalence.msm(m2,times=seq(1,25,1))
    ...
    plot.prevalence.msm(m2,mintime = 0,maxtime=25)
