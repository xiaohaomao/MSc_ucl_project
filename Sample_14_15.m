...
for i=1:N,
    ...
    if rand(1)<=0.9;
        ...
        time_interval(1)=wblrnd(4,0.5,[1,1]);
        if rand(1)<=0.9
            % path state 1 -> state 2 -> state 3
            time_interval(2)=wblrnd(4,0.5,[1,1]);
            
            if rand(1)<=0.9
                % path state 1 -> state 2 -> state 3 -> state 4 -> state 5
                time_interval(3)=wblrnd(4,0.5,[1,1]);
                time_interval(4)=wblrnd(4,0.5,[1,1]);
        ...
        time_interval=wblrnd(4,0.5,[1,1]);
