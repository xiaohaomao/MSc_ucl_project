...
d1=read.csv('C:/Users/xiaohao/Documents/Rwork/TestData_12_08_03.CSV', header=TRUE)
...
name_of_excel<-list("1208_test_exponential_output_03.xlsx")
name_of_plot<-list("1208_test_exponential_output_03")
