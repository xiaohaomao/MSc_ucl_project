...
d1=read.csv('C:/Users/xiaohao/Documents/Rwork/TestData_24_08_11.CSV', header=TRUE)
...
name_of_excel<-list("2408_test_chi2s_output_11.xlsx")
name_of_plot<-list("2408_test_chi2s_output_11")
