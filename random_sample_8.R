...
d1=read.csv('C:/Users/xiaohao/Documents/Rwork/TestData_12_08_06.CSV', header=TRUE)
...
name_of_excel<-list("1208_test_random_output_06.xlsx")
name_of_plot<-list("1208_test_random_output_06")
