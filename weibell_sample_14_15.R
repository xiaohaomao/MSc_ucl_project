...
d1=read.csv('C:/Users/xiaohao/Documents/Rwork/TestData_26_08_05.CSV', header=TRUE)
...
name_of_excel<-list("2608_test_weibull_output_05.xlsx")
name_of_plot<-list("2608_test_weibull_output_05")
...
for (i in 1:1){
  ...
  for(k in 2:2){
    ...
    options(digits=3)
    prevalence<-prevalence.msm(m2,times=seq(1,35,1))
    ...
    plot.prevalence.msm(m2,mintime = 0,maxtime=35)
