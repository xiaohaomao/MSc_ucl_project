...
for i=1:N,
   ...
   % path state 1 -> state 2
        ...
        time_interval(1)=mean(gamrnd(0.5,6,[1,1]));
        if rand(1)<=0.9
            % path state 1 -> state 2 -> state 3
            time_interval(2)=mean(gamrnd(0.5,6,[1,1]));
            
            if rand(1)<=0.9
                 % path state 1 -> state 2 -> state 3 -> state 4 -> state 5
                time_interval(3)=mean(gamrnd(0.5,6,[1,1]));
                time_interval(4)=mean(gamrnd(0.5,6,[1,1]));
        ...
        time_interval=mean(gamrnd(0.5,6,[1,1]));
